    ...
    return (
        <aside className="sidebar">
            <a href="/" className="sidebar-brand">
                <div className="sidebar-brand-icon"><Shield size={22} /></div>
                <span className="sidebar-brand-text">Ready<span>Barangay</span></span>
            </a>

            <div className="sidebar-alert-level">
                <div className="alert-level-dot" />
                <div className="alert-level-text">
                    <div className="alert-level-label">Alert Level</div>
                    <div className="alert-level-value">Yellow — Moderate</div>
                </div>
            </div>
            ...
            <div className="sidebar-user" onClick={() => onNavigate("/profile")}>
                ...
                <div className="sidebar-user-info">
                    <div className="sidebar-user-name">Juan dela Cruz</div>
                    <div className="sidebar-user-role">Barangay Captain</div>
                </div>
...
export default function ProfilePage() {
    ...
    const [form, setForm] = useState({
        firstName: "Juan",
        lastName: "dela Cruz",
        email: "juan.delacruz@sanisidro.gov.ph",
        phone: "+63 917 123 4567",
        position: "Barangay Captain",
        barangay: "Barangay San Isidro",
        municipality: "Quezon City",
        province: "Metro Manila",
        bio: "Serving Barangay San Isidro since 2022. Committed to building a safer, more prepared community through technology and community engagement.",
    });
    ...
    return (
        <div className="app-shell">
            <Sidebar activePath={activePath} onNavigate={(p) => navigate(p)} />
                    ...
                    <div className="profile-hero">
                        ...
                        <div className="profile-hero-left">
                            ...
                            <div className="profile-hero-info">
                                ...
                                <h1 className="profile-name">Juan dela Cruz</h1>
                                <div className="profile-meta-row">
                                    <span className="profile-meta-item"><MapPin size={14} style={{ marginRight: 6 }} /> Barangay San Isidro, QC</span>
                                    <span className="profile-meta-sep">·</span>
                                    <span className="profile-meta-item"><Mail size={14} style={{ marginRight: 6 }} /> juan.delacruz@sanisidro.gov.ph</span>
                                    <span className="profile-meta-sep">·</span>
                                ...
                                <div className="profile-card">
                                    ...
                                    <div className="profile-fields">
                                        ...
                                        <div className="profile-field">
                                            ...
                                            {editMode ? (
                                                <input className="profile-input" type="tel" value={form.phone} onChange={(e) => update("phone", e.target.value)} />
                                            ) : (
                        ...
                        <div className="profile-tab-content">
                            <div className="profile-card profile-card-full">
                                <div className="profile-card-header">
                                    ...
                                    <button className="profile-edit-btn"><Edit size={14} style={{ marginRight: 6 }} /> Edit</button>
                                </div>
                                <div className="profile-fields profile-fields-max">
                                    <div className="profile-field-row">
                                        <div className="profile-field">
                                        ...
                                        <div className="profile-field">
                                            ...
                                            <div className="profile-field-value">{form.municipality}</div>
                                        </div>
                                    </div>
                                    <div className="profile-field-row">
                                        <div className="profile-field">
                                            <label className="profile-field-label">Province / Region</label>
                                            <div className="profile-field-value">{form.province}</div>
                                        </div>
                                        <div className="profile-field">
                                            <label className="profile-field-label">Barangay ID</label>
                                            <div className="profile-field-value">BRG-137-QC-2022</div>
                                        </div>
                                    </div>
